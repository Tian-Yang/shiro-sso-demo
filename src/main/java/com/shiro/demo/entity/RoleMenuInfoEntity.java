 ...
 * @TableName TianYang
 */
@TableName(value ="role_menu_info")
@Data
public class RoleMenuInfoEntity extends BaseEntity implements Serializable {
    /**
     * 
     */
    @TableId
    ...
    public boolean equals(Object that) {
        ...
        RoleMenuInfoEntity other = (RoleMenuInfoEntity) that;
